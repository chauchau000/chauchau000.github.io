  ...
  return (
    <section id="contact" className="section bg-primary">
      <div className="container">
        <div className="row">
          <div className="col-lg text-center text-lg-center wow fadeInUp">
            <h2 className="text-10 fw-600 mb-5">Let's get in touch</h2>
            <p className="text-5 mb-5">
              I enjoy discussing new projects and challenges. Please contact me with any additional questions. 
            </p>
            ...
            <p className="text-4">adrienne.tran@gmail.com</p>
            <ul className="social-icons social-icons-lg justify-content-center justify-content-lg-center mt-5">
